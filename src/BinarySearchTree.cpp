...
bool BinarySearchTree::searchWord(std::string word)
{
    BSTNode* cur;
...
BSTNode* BinarySearchTree::searchNode(std::string word)
{
    BSTNode* cur;
...
void BinarySearchTree::insertWord(std::string word)
{
    BSTNode *cur, *parent;
...
void BinarySearchTree::deleteWord(BSTNode* &root, std::string word)
{
    BSTNode *cur, *parent;
    if ((cur = searchNode(word)))
    {
...
void BinarySearchTree::rangeSearch(std::string first, std::string last)
{
    inOrderRange(root, first, last);
}

void BinarySearchTree::inOrderRange(BSTNode* root, std::string first, std::string last)
{
    if (root == nullptr)
    {
        return;
